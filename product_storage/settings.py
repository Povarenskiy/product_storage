"""
Django settings for product_storage project.
...
SECRET_KEY = 'django-insecure-dd5n_(b5zow%9uztq=q=i=e!@(4t0-mxaxk^&(^uw6jno=un@k'
...
ROOT_URLCONF = 'product_storage.urls'
...
WSGI_APPLICATION = 'product_storage.wsgi.application'
